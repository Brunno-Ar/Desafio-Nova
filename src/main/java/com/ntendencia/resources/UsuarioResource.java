...
public class UsuarioResource {
    ...
    public ResponseEntity<Void> atualizarUsuario(@Valid @RequestBody UsuarioDTO objDto, @PathVariable Integer id) {
    ...
    public ResponseEntity<Void> inserirNovoUsuario(@Valid @RequestBody UsuarioNewDTO objDto) {
        Usuario obj = service.inserirObjetoPeloDTO(objDto);
